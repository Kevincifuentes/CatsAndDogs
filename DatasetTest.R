...
#setwd("/Users/kevin/Desktop/Master/InteligenciaArtificial/R/Proyecto/test")
...
#fpath<-"/Users/kevin/Desktop/Master/InteligenciaArtificial/R/Proyecto/test/"
...
images[3:15]<-NULL
DatasetTest <- cbind(images, images2)

############### Guardamos el dataset ##################
# -----------------------------------------------------
write.csv(DatasetTest,file="DatasetTest.csv")
