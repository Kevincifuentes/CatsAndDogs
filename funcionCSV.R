crearCSVImagen = function(files){
  ...
  #setwd("C:\\Users\\LAPTOP\\Desktop\\I.A.A\\PROYECTO\\test")
  #images <- list.files(pattern = ".jpg") # Load images names, only JPGs) # Load images names
  #fpath<-"C:\\Users\\LAPTOP\\Desktop\\I.A.A\\PROYECTO\\test\\"
  fpath<-"/Users/kevin/Desktop/Master/InteligenciaArtificial/R/Proyecto/"
  ...
  images$feature_numberOfStringPixelsForEdges<-NA
    ...
    #library(imager)
    pet <- load.image(files$datapath) # leer con libreria imager
    ...
    images$feature_mean_green <-feature_mean_green
    #Sacar valor Azul promedio, sumar los ultimos 40000 valores del canal 3 y sacar la media
    blue<-tail(pet,40000)
    feature_mean_blue<-mean(blue$value)
    images$feature_mean_blue <-feature_mean_blue
    
    #Sacar la luminosidad
    pet <- load.image(files$datapath) # leer con libreria imager  58
    pet<- resize(pet,height,width)
    ...
    images$feature_mean_gradient <-feature_mean_gradient
    ...
    images$feature_mean_gradient_channel1 <-feature_mean_gradient_channel1
    ...
    images$feature_mean_gradient_channel2 <-feature_mean_gradient_channel2
    ...
    images$feature_mean_gradient_channel3 <-feature_mean_gradient_channel3
    ...
    images$feature_numberOfLittleObjects <-feature_numberOfLittleObjects
    ...
    images$feature_numberOfMediumObjects <-feature_numberOfMediumObjects
    ...
    images$feature_detectedStrongEdges <-feature_detectedStrongEdges
    images$feature_detectedWeakEdges <-feature_detectedWeakEdges
    ...
    images$feature_numberOfStringPixelsForEdges <-feature_numberOfStringPixelsForEdges 
